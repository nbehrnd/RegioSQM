...
** Local installation
   ...
   essential dependencies /of this script/ can be resolved by running
   ...
   MOPAC and optional GNU Parallel are external dependencies
   /for the intended analysis/, not for running the script itself.
